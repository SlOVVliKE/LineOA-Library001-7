 ...
 *
 * prefetch={false} — สำคัญกับเว็บนี้เป็นพิเศษ
 *
 * ปกติ Next จะแอบโหลดหน้าปลายทางของทุกลิงก์ที่โผล่บนจอไว้ล่วงหน้า
 * หน้าร้านมีลิงก์หนังสือ 8 เล่ม บวกเมนูอีก 3 รวมเป็นโหลดล่วงหน้า 11 หน้า
 * และทุกหน้าเป็น force-dynamic จึงต้องเรนเดอร์จริงและยิง Supabase จริงทุกหน้า
 * เท่ากับเปิดหน้าร้านหนึ่งครั้ง เซิร์ฟเวอร์ทำงาน 12 หน้า
 *
 * วัดจากเว็บจริงแล้วเจอ 11 request แบบนี้จริง และมีตัวหนึ่งตอบ 503 เพราะรับไม่ไหว
 * ปิดแล้วหน้าปลายทางจะโหลดตอนกดจริงเท่านั้น ช้ากว่าเดิมเสี้ยววินาที
 * แลกกับเซิร์ฟเวอร์ที่ไม่ต้องทำงานเปล่า 11 เท่าในทุกครั้งที่มีคนเปิดหน้าร้าน
 *
